...
/** Speech bubble — used for send-feedback FAB */
export function IconFeedback({ size = 18 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconArrowSend({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconThumbUp({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M7 10v10" />
      <path d="M3.5 11.5a1.5 1.5 0 0 1 1.5-1.5h2v10H5a1.5 1.5 0 0 1-1.5-1.5v-7Z" />
      <path d="M7 10l4.5-6.2a1.6 1.6 0 0 1 2.9 1.1L14 9.5h4.8a2 2 0 0 1 1.95 2.44l-1.25 5.5A3.2 3.2 0 0 1 16.38 20H7" />
    </svg>
  );
}
...
export function IconPlusCircle({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2.5a9.5 9.5 0 1 0 0 19 9.5 9.5 0 0 0 0-19Zm4.25 10.25h-3.5v3.5a.75.75 0 0 1-1.5 0v-3.5h-3.5a.75.75 0 0 1 0-1.5h3.5v-3.5a.75.75 0 0 1 1.5 0v3.5h3.5a.75.75 0 0 1 0 1.5Z" />
    </svg>
  );
}
...
export function IconCamera({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M8.5 6 10 4h4l1.5 2H19a2 2 0 0 1 2 2v9.5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3.5Z" />
      <circle cx="12" cy="12.5" r="3.25" />
    </svg>
  );
}

export function IconPhoto({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPaperclip({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconFolder({ size = 16 }: { size?: number }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.4a2 2 0 0 1-1.7-.9L9.2 3.1A2 2 0 0 0 7.5 2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2Z" />
    </svg>
  );
}
